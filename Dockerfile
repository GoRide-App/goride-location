...
COPY src/GoRide.Location/GoRide.Location.csproj src/GoRide.Location/
RUN dotnet restore src/GoRide.Location/GoRide.Location.csproj
...
ENTRYPOINT ["dotnet", "GoRide.Location.dll"]
